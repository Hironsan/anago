...
import numpy as np
from keras.layers import Dense, LSTM, Bidirectional, Embedding, Input, Dropout, Conv1D
...
from anago.data import jp_loader
...
class NeuralEntityModel(object):
    ...
    def _build_model(self):
        ...
        layer = word2vec_embedding_layer2('../../data/word2vec.ja/embeddings.jp.npz',
                                          '../../data/word2vec.ja/map.jp.json',
                                          word_index,
...
if __name__ == '__main__':
    ...
    print('Loading data...')
    X_train, y_train, X_test, y_test, index2word, index2chunk = jp_loader.load_data(word_preprocess=lambda w: w.lower())
    ...
    model.train(X_train, y_train, batch_size, epochs=20)
